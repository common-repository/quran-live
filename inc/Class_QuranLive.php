...
class Render_Quran_Live{
	...
	static function load_sura_quran_live($sura=null,$lang,$cheikh){
		...
		echo '<p id="audio_live_quran">
				<audio controls id="au" autoplay="autoplay" style="display:block;" src="https://quran.s3.fr-par.scw.cloud/verset/Shuraym/1/1.mp3" type="audio/mpeg">
...
if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
		...
		if(sura == 9 || sura ==1){
			document.getElementById("au").src="https://quran.s3.fr-par.scw.cloud/verset/no.mp3";
			a.load();
		}
		...
		?>
		document.getElementById("au").src="https://quran.s3.fr-par.scw.cloud/verset/<?=$cheikh;?>/"+sura+"/"+c+".mp3";
